...
public class WgApiProperties extends Properties {
    ...
    public String getApplicationId() {
        return getStringProperty("io.github.divinator.wgapi.id", null);
    }
    ...
    public int getConnectionTimeout() {
        return getIntegerProperty("io.github.divinator.wgapi.connection.timeout", 30000);
    }
    ...
    public String getProxyHost() {
        return getStringProperty("io.github.divinator.wgapi.proxy.host", null);
    }
    ...
    public int getProxyPort() {
        return getIntegerProperty("io.github.divinator.wgapi.proxy.port", 80);
    }
