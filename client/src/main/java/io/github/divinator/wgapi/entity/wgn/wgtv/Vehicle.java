...
/**
 * Класс описывает сущность "Отфильтрованный по играм список техники, о которой есть видео." для метод-блока {@link io.github.divinator.wgapi.method.wgn.WgtvMethod}
 *
 * @author Sergey Divin
 */
