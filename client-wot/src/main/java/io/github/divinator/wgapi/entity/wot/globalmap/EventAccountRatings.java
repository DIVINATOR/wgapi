...
/**
 * Сущность описывает "Рейтинг игрока в событии" для метод-блока {@link GlobalMapMethod}
 *
 * @author Sergey Divin
 */
public final class EventAccountRatings {
    ...
    /**
     * Метод возвращает дата обновления данных аккаунта.
     *
